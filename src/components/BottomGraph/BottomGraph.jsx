function Chart({ selectedCrypto, setClose }) {
  return (
    <div>
      {selectedCrypto ? (
        <div>
          <section className="relative">
            ...
            <button onClick={() => setClose(true)} type="button" className="absolute top-0 right-0">
              <svg
        ...
        <div className="text-lg leading-6 font-medium text-gray-900 my-8">
          Select one Crypto to see graphical data!
        </div>
      )}
    </div>
  );
